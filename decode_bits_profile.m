function [bit_chain, adjust_row] = decode_bits_profile(BW, row_idx, space_in_row, space_size_m, bit_size_m, adjust_row)
...
origin_y = 240 + (row_idx-1)*space_in_row+adjust_row;
%get optimum inclination
end_y_center = 240 + (row_idx-1)*space_in_row+adjust_row; %this is fixed
end_x = 1055; %this is fixed
search_range = 8;
cnt = 1;
